...
'''
project_dir, filename = os.path.split(os.path.dirname(os.path.realpath(__file__)))
...
class MyLog:
    ...
    def _generateLoggerFilename(self, directory, file='', master=False):
        '''
        ...
        if master == False:
            ...
            if file:
                ...
                filename = 'ATE_{}-{}_{}_{}.log'.format(Scenario.ateTestAttr['station'], Scenario.ateTestAttr['stationIndex'],
                                                       Scenario.ateTestAttr['serial_number_heart_rate'],
    ...
    def loggerQueueListenerProcess(self, queue, logOutputFD):
        ...
        while True:
            ...
            logOutputFD.write(logMessage.__dict__['msg'] + '\n')
            logOutputFD.flush()

            # print('   logMesage Formatted = ' + self._formatter.format(logMessage))

    def startupTheLoggers(self, directory, mpQueue=None, master=False):
        '''
        ...
        self._pathname = self._generateLoggerFilename(directory, '', master)
